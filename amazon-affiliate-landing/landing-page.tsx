...
import { CashbackSection } from "@/components/sections/cashback-section"
import { PopularStoresSection } from "@/components/sections/popular-stores-section"
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-b from-pink-50 to-white">
      ...
      <main className="flex-1">
        ...
        <BlogSection />
        {/* New CashKaro-inspired sections */}
        <CouponsSection />
        <CashbackSection />
